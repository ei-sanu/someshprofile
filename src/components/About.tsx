import { Cloud, Code, Lock, Network, Shield, Terminal } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div
              className="bg-slate-900 border border-blue-500/30 rounded-lg p-6 font-mono text-sm"
            >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {skills.map((skill, index) => (
                <div
                  key={skill.name}
                  className="group bg-gradient-to-br from-slate-900 to-slate-950 border border-blue-500/30 rounded-lg p-6 transition-all cursor-pointer"
                >
                  <div>
