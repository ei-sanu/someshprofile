    ...
    <section className="py-20 bg-gradient-to-b from-slate-950 to-slate-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div
            className="bg-gradient-to-br from-slate-900 to-slate-950 border-2 border-blue-500/30 rounded-2xl p-8 transition-all"
          >
            <div className="flex items-start space-x-6 mb-8">
              ...
              <div className="flex-1">
                ...
                <div
                  className="flex items-center space-x-3 text-cyan-400 mb-2"
                >
            ...
            <div className="border-t border-blue-500/30 pt-6">
              ...
              <a
                ...
                className="inline-block px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-medium transition-all"
              >
                APPLY FOR LPUNEST
              </a>
